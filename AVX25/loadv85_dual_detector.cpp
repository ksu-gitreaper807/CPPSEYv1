...
//
// At 3Hz exactly, a 1-second window contains 3 onsets (3 > 2 → alarm ✓).
// At 2Hz it contains 2 (2 > 2 is false → no alarm ✓).  No min_sep needed.
//
    ...
    PSEState16&          state) noexcept
{
    ...
    // Scale strobe threshold proportionally: 3/8 → 6/16
    const bool is_strobe_pattern = (sign_changes >= 6);
    ...
    // Frame index broadcast registers — all 16 slots
    const __m256i idx0  = _mm256_set1_epi8((uint8_t)f[0]);
    const __m256i idx1  = _mm256_set1_epi8((uint8_t)f[1]);
    const __m256i idx2  = _mm256_set1_epi8((uint8_t)f[2]);
    const __m256i idx3  = _mm256_set1_epi8((uint8_t)f[3]);
    ...
    const __m256i idx6  = _mm256_set1_epi8((uint8_t)f[6]);
    const __m256i idx7  = _mm256_set1_epi8((uint8_t)f[7]);
    const __m256i idx8  = _mm256_set1_epi8((uint8_t)f[8]);
    const __m256i idx9  = _mm256_set1_epi8((uint8_t)f[9]);
    const __m256i idx10 = _mm256_set1_epi8((uint8_t)f[10]);
    const __m256i idx11 = _mm256_set1_epi8((uint8_t)f[11]);
    const __m256i idx12 = _mm256_set1_epi8((uint8_t)f[12]);
    const __m256i idx13 = _mm256_set1_epi8((uint8_t)f[13]);
    const __m256i idx14 = _mm256_set1_epi8((uint8_t)f[14]);
    const __m256i idx15 = _mm256_set1_epi8((uint8_t)f[15]);
